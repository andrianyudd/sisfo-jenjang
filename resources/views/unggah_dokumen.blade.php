                        ...
                        <div class="card shadow-sm">
                            <div class="card-body" style="margin-top: 80px;">
                                ...
                                <form action="proses_unggah.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="transkrip" class="form-label">Ijazah (PDF)</label>
                                        <input type="file" class="form-control" id="transkrip" name="transkrip" accept=".pdf" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="transkrip" class="form-label">Akreditasi Perguruan Tinggi (PDF)</label>
                                        <input type="file" class="form-control" id="transkrip" name="transkrip" accept=".pdf" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="transkrip" class="form-label">Akreditasi Program Studi (PDF)</label>
                                        <input type="file" class="form-control" id="transkrip" name="transkrip" accept=".pdf" required>
                                    </div>
